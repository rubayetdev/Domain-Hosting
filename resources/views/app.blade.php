    ...
    <nav id="sidebar" class="sidebar js-sidebar">
        <div class="sidebar-content js-simplebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item {{ Request::is('renewDomain') ? 'active' : '' }}">
                    <a class="sidebar-link" href="{{ route('renewDomain') }}">
                        <i class="align-middle" data-feather="user-plus"></i> <span class="align-middle">Renew Domain</span>
                    </a>
                </li>
            ...
            <ul class="navbar-nav navbar-align">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                        @if(Auth::user()->companyInfo && Auth::user()->companyInfo->companyLogo)
                            <img src="{{ asset('storage/' . Auth::user()->companyInfo->companyLogo) }}" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark">{{Auth::user()->companyInfo->companyName}}</span>
                        @endif
                    </a>
