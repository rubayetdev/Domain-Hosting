    ...
    <nav id="sidebar" class="sidebar js-sidebar">
        <div class="sidebar-content js-simplebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item {{ Request::is('admin/domains/index') ? 'active' : '' }}">
                    <a class="sidebar-link" href="{{ route('admin.domain') }}">
                        <i class="align-middle" data-feather="globe"></i> <span class="align-middle">Add Domain</span>
                    </a>
                </li>
                ...
                <ul class="navbar-nav navbar-align">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                                ...
                                <img src="{{asset('John Doe.jpg')}}" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark">John Doe</span>
